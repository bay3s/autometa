...
class AntVelocityEnv(BaseAntEnv, EzPickle):
    ...
    def __init__(
        ...
        """
        Ant environment with rewards based on achieving a target velocity for Mujoco Ant locomotor.
        ...
        tasks are generated by sampling the target velocity from the uniform distribution on [0, 3].
